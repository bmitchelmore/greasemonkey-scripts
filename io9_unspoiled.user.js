...
var mainContent = document.evaluate("//div[contains(@class,'post-permalink')][//a[@class='topTag' and contains(@href, 'morning-spoilers')]]", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
if (mainContent) {
    var headers = document.evaluate("//div[@class='entry']/p[*[(self::u or self::em) and ((position() = 1 and position() = last()) or preceding-sibling::br[1] or following-sibling::img[1]) and not(self::parent/following-sibling::blockquote[1]) and not(self/following-sibling::blockquote[1])]]", mainContent, null, XPathResult.ORDERED_NODE_SNAPSHOT_TYPE, null);
